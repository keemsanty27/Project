...
<div class="py-5" style=" background-size: cover, 100%; background-position: top left, top left;  background-repeat: repeat, repeat;  background-color:#ffffff;">
  ...
  <!--tab nav-->
  <div class="container">
  <h2>Generate Equipment Report</h2>
  <br>
 
       <!--form start-->
<form action="jspdf-dump-ITE.php" method="POST" id="signatureform" autocomplete="off">    
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" />
  ...
  <div class="container">
  <h2>Generate Equipment Report by Owner</h2>
  <br>
 
       <!--form start-->
<form action="jspdf-dump-ITE2.php" method="POST" id="signatureform" autocomplete="off">    
