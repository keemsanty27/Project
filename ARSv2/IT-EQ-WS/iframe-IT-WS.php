...
<body>
  ...
  <ul class="nav nav-pills">
    <li class="nav-item">
      <a class="nav-link" href="iframe-IT-EQ" style="color: #000000">IT Peripheral History</a>
    </li>
    <li class="nav-item">
      <a class="nav-link active" href="iframe-IT-WS">IT Workstation History</a>
    </li>
  </ul>
    </div>
  </div>
...
<table class="table-sm" cellspacing="0" border="0" style="width: 50%; margin: 0 auto 2em auto;">
        <thead>
            <tr>
                <th>Search History - IT Workstation</th>
                <!--th>Search text</th-->
...
<table id="myTable" class="table-responsive-sm table-striped table-bordered" style="width: 100%; ">
              <thead>
                <tr>
  ...
  <div class="container" align="center">
          <a class="btn btn-primary" href="iframe-Request-Report-ITWS.php"><i class="fa fa-line-chart"></i>&nbsp;Generate Reports</a>
      </div>
    </div>
  </div>
<hr>
