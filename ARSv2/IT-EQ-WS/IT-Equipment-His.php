...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="IT-Equipment-His">IT Equipment and Workstations History</a></li>
    </ol>
</nav>
  ...
  <iframe class="responsive-iframe embed-responsive-item" src="iframe-IT-EQ.php" allowfullscreen></iframe>
</div>
