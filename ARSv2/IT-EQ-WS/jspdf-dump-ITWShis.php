...
<p><a href='iframe-IT-WS.php'>Back</a>
<p>Selected rows:</p>
...
<table id="myTable" style="font-size: 12px">
			<thead>
              ...
              $result = mysqli_query($link,"SELECT * FROM request WHERE date(D_n_T) BETWEEN '".$startdate."' AND '".$enddate."' AND property_no = '".$property_no."'");   

              echo "Dates Between: $startdate and $enddate <br>";
              echo "Property No.: $property_no"
              ?>
...
function generate() {
  ...
  const header = function(data) {
    ...
    doc.text('Workstation History Report',  data.settings.margin.left + 320, 60 )
  };
