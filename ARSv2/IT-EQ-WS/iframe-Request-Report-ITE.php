...
<div class="py-5" style=" background-size: cover, 100%; background-position: top left, top left;  background-repeat: repeat, repeat;  background-color:#ffffff;">
  ...
  <!--tab nav-->
  <div class="container">
  <h2>Generate History Report by date</h2>
  <br>
 
       <!--form start-->
<form action="jspdf-dump-ITEhis.php" method="POST" id="signatureform" autocomplete="off">    
...
<link href="https://unpkg.com/gijgo@1.9.13/css/gijgo.min.css" rel="stylesheet" type="text/css" /-->
  ...
  <br>
         <!--form start-->
<div class="container">
  <h2>Generate History Report by Unit Type and Property No.</h2>
  <br>
         <!--h2>Generate IT Equipment History Report by User</h2-->
<form action="jspdf-dump-ITEhis2.php" method="POST" id="signatureform" autocomplete="off">    
...
<!--status of the request-->
        ...
        <div class="form-group">
          <label for="exampleFormControlSelect1">
            <h3>Unit Type:<span class="span-ask">*</span></h3>
          </label>
          <input type="text" style="width: 300px;" class="form-control" name="unittype" id="assigned_to" required>
          <br>
           <label for="exampleFormControlSelect1">
            <h3>Property Number:<span class="span-ask">*</span></h3>
          </label>
          <input type="text" style="width: 300px;" class="form-control" name="property_no" id="assigned_to" required>
        </div>
