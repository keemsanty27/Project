...
<table id="myTable" style="font-size: 12px">
      <thead>
              ...
              $result = mysqli_query($link,"SELECT * FROM it_workstation WHERE date_acquired BETWEEN '".$startdate."' AND '".$enddate."' AND assigned_to = '".$assigned_to."' ORDER BY date_acquired ASC");   
...
function generate() {
  ...
  const header = function(data) {
    ...
    doc.text('Workstation Report',  data.settings.margin.left + 340, 60 )
  };
