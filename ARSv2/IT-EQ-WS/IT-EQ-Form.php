            ...
            <ul class="list-unstyled components">
                ...
                <li  class="active">
                     ...
                     <ul class="collapse list-unstyled" id="pageSubmenu">
                        ...
                        <li>
                            <a href="CSV-Upload-EQ" style="color: white;">Upload</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="IT-EQ-Form">IT Equipment and Workstations</a></li>
    </ol>
</nav>         

            <div class="line"></div>
            <div class="container" style="margin-left: auto; margin-right: auto;">
            <h1 style="align-self: center;">IT Equipment and Workstations</h1>
            </div>
            <div class="line"></div>

          <div class="embed-responsive embed-responsive-16by9">
  <iframe class="responsive-iframe embed-responsive-item" src="iframe-EQ-Form.php" allowfullscreen></iframe>
</div>
