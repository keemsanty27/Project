...
<table id="myTable" style="font-size: 12px">
			<thead>
              ...
              $startdate = $_POST['date_start3'];
              $enddate = $_POST['date_end3'];
              $acc_by = $_POST['con_by'];
              $result = mysqli_query($link,"SELECT * FROM request WHERE date(D_n_T) BETWEEN '".$startdate."' AND '".$enddate."' AND Acc_by = '".$acc_by."' ORDER BY D_n_T ASC");   

              echo "Dates Between: $startdate and $enddate";
              echo "Accomplished by: $acc_by";
              ?>
