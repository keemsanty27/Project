            ...
            <ul class="list-unstyled components">
                ...
                <li>
                     ...
                     <ul class="collapse list-unstyled" id="pageSubmenu">
                        <li>
                            <a href="../IT-EQ-WS/IT-EQ-Form.php" style="color: white;">Create new entry / View</a>
                        </li>
                        <li>
                            <a href="../IT-EQ-WS/IT-Equipment-His" style="color: white;">View History</a>
                        </li>
                        <li>
                            <a href="../IT-EQ-WS/CSV-Upload-EQ" style="color: white;">Upload</a>
                        </li>
                    </ul>
                </li>
            </ul>
...
<nav>
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="View-Request">View Request</a></li>
    </ol>
</nav>  

            <div class="line"></div>
            <div class="container" style="margin-left: auto; margin-right: auto;">
            <h1 style="align-self: center;">Requests</h1> <br>
            <div class="line"></div>

          <div class="embed-responsive embed-responsive-16by9">
  <iframe class="responsive-iframe embed-responsive-item" src="iframe-View-Requests.php" seamless="seamless" width="300" allowfullscreen></iframe>
